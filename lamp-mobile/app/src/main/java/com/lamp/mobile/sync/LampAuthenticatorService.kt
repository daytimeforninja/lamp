...
class LampAuthenticator(context: Context) : AbstractAccountAuthenticator(context) {
...
class LampAuthenticatorService : Service() {
    private lateinit var authenticator: LampAuthenticator

    override fun onCreate() {
        super.onCreate()
        authenticator = LampAuthenticator(this)
    }
